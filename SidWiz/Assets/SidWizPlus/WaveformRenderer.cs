...
*/
        ...
        private void Render(Image destination, byte[] imageBuffer, Action onFrame, int startFrame, int endFrame)
        {
            ...
            for (int i = 0; i < _channels.Count; ++i)
            {
                ...
                var x = column * renderingBounds.Width / Columns + renderingBounds.Left;
                var y = row * renderingBounds.Height / numRows + renderingBounds.Top;
        ...
        /// </summary>
        public void RenderFrame(float position, Bitmap bitmap)
        {
